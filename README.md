...
|Invert QE1 | Inverts the direction of the turntable. Infinitas expects clockwise motion of the turntable to be positive x direction (to the right). If you check this, it will be flipped. |
